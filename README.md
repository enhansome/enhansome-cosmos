...
**Contributing:**
Please read the [Contributing guide](./CONTRIBUTING.md). Thank you to all our [contributors](https://github.com/cosmos/awesome/graphs/contributors) ⭐ 602 | 🐛 10 | 📅 2026-04-13.
...
* [Cosmos Hub](https://github.com/cosmos/gaia) ⭐ 573 | 🐛 32 | 🌐 Go | 📅 2026-09-09

<!-- -->

* [Cosmos SDK](https://github.com/cosmos/cosmos-sdk/) ⭐ 7,058 | 🐛 225 | 🌐 Go | 📅 2026-09-10
* [CosmWasm](https://github.com/CosmWasm/cosmwasm) ⭐ 1,144 | 🐛 42 | 🌐 Rust | 📅 2026-09-06
* [CometBFT](https://github.com/cometbft/cometbft) ⭐ 918 | 🐛 280 | 🌐 Go | 📅 2026-09-07
* [CosmJS](https://github.com/cosmos/cosmjs) ⭐ 700 | 🐛 191 | 🌐 TypeScript | 📅 2026-05-04
* [IBC Go](https://github.com/cosmos/ibc-go) ⭐ 646 | 🐛 35 | 🌐 Go | 📅 2026-09-10

<!-- -->

* [IAVL](https://github.com/cosmos/iavl) ⭐ 446 | 🐛 78 | 🌐 Go | 📅 2026-05-18
* [ICS23](https://github.com/cosmos/ics23) ⭐ 129 | 🐛 32 | 🌐 Rust | 📅 2026-04-13
...
* [Ignite CLI](https://github.com/ignite/cli) ⭐ 1,351 | 🐛 16 | 🌐 Go | 📅 2026-09-10 - All-in-one platform to build, launch, and maintain any crypto application on a sovereign and secured blockchain. Quickly bootstraps a new Cosmos SDK blockchain with UI and support to create new and work conveniently with existing Cosmos SDK modules.

### JavaScript

* [cosmos/cosmjs](https://github.com/cosmos/cosmjs) ⭐ 700 | 🐛 191 | 🌐 TypeScript | 📅 2026-05-04 - The Cosmos JavaScript library.
...
* [strangelove-ventures/graz](https://github.com/strangelove-ventures/graz) ⭐ 123 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-10 - Collection of React hooks to interact with wallets, signers, signing clients, etc.
* [cosmology-tech/chain-registry](https://github.com/cosmology-tech/chain-registry) ⭐ 70 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-10 - A npm package for the official Cosmos Chain Registry.
...
* [cosmpy](https://github.com/fetchai/cosmpy) ⭐ 149 | 🐛 44 | 🌐 Python | 📅 2026-09-04 - A Python client library for interacting with blockchains based on the Cosmos SDK.
...
* [CosmWasm/cosmwasm](https://github.com/CosmWasm/cosmwasm) ⭐ 1,144 | 🐛 42 | 🌐 Rust | 📅 2026-09-06 - WebAssembly Smart Contracts for the Cosmos SDK.
* [iqlusioninc/stdtx](https://github.com/iqlusioninc/crates) ⭐ 579 | 🐛 48 | 🌐 Rust | 📅 2026-09-09 - A collection of open source Rust crates from iqlusion.
...
* [cosmos/chain-registry](https://github.com/cosmos/chain-registry/) ⭐ 570 | 🐛 111 | 🌐 Python | 📅 2026-09-09
...
* [BDJuno](https://github.com/forbole/bdjuno) ⭐ 93 | 🐛 44 | 🌐 Go | 📅 2024-11-25 - All the chains' data that are queried from the RPC and gRPC endpoints are stored inside a PostgreSQL database on top of which GraphQL APIs can then be created using Hasura.
* [Cosmos Indexer](https://github.com/DefiantLabs/cosmos-indexer) ⭐ 36 | 🐛 11 | 🌐 Go | 📅 2026-09-09 - A generalized DB schema indexer with correlation and direct database indexing in Go.
...
* [Cosmos SDK](https://github.com/cosmos/cosmos-sdk/) ⭐ 7,058 | 🐛 225 | 🌐 Go | 📅 2026-09-10 - A Framework for Building High Value Public Blockchains in Go.
...
* [CosmWasm](https://github.com/CosmWasm/cosmwasm) ⭐ 1,144 | 🐛 42 | 🌐 Rust | 📅 2026-09-06 - WASM Virtual Machine & Rust Smart Contracts.
* [Polaris](https://github.com/berachain/polaris) ⚠️ Archived - Modular Ethereum Virtual Machine.
* [Agoric SDK](https://github.com/Agoric/agoric-sdk) ⭐ 358 | 🐛 1,808 | 🌐 TypeScript | 📅 2026-09-10 - Agoric JavaScript Smart Contract Platform.

## IBC

* [Interchain Standards](https://github.com/cosmos/ibc/) ⭐ 1,018 | 🐛 66 | 🌐 Go | 📅 2026-09-10 - Interchain Standards (ICS) for the Cosmos network & interchain ecosystem.
* [cosmos/ibc-go](https://github.com/cosmos/ibc-go) ⭐ 646 | 🐛 35 | 🌐 Go | 📅 2026-09-10 - Inter-Blockchain Communication protocol (IBC) implementation in Go.
...
* [IBC-escrow-auditor](https://github.com/Cordtus/ibc-escrow) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-06 - Standalone tool to check and report on-chain token amounts against the IBC lockup account on counterparty chain.
* [IBCprotocol.dev](https://ibcprotocol.dev/) - IBC Protocol website.

## Testing

* [quint](https://github.com/informalsystems/quint) ⭐ 1,665 | 🐛 252 | 🌐 TypeScript | 📅 2026-08-20 - Executable specification language with delightful tooling.
* [apalache](https://github.com/informalsystems/apalache) ⭐ 597 | 🐛 259 | 🌐 Scala | 📅 2026-09-10 - APALACHE: symbolic model checker for TLA+ and Quint.
* [interchaintest](https://github.com/strangelove-ventures/interchaintest) ⭐ 197 | 🐛 78 | 🌐 Go | 📅 2026-02-11 - E2E testing framework for IBC Chains.
...
* [spawn](https://github.com/rollchains/spawn) ⭐ 112 | 🐛 24 | 🌐 Go | 📅 2026-02-06 -  Generate a new Cosmos SDK blockchain with testing, GitHub integrations, and easy instant testnets.
...
* [cosmosvisor](https://github.com/cosmos/cosmos-sdk/tree/main/cosmovisor#readme) ⭐ 7,058 | 🐛 225 | 🌐 Go | 📅 2026-09-10 - Automates Cosmos SDK application binary upgrades.
* [tmkms](https://github.com/iqlusioninc/tmkms) ⭐ 366 | 🐛 30 | 🌐 Rust | 📅 2026-04-06 - Key Management System for Tendermint validators.
...
* [Skip:Go](https://go.skip.build) - IBC token transfers, automated swapping and multi-hop routing ([source](https://github.com/skip-mev/skip-go-app) ⭐ 31 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-10).
...
* [Cosmos Discord Bot](https://github.com/okp4/discord-bot) ⭐ 8 | 🐛 19 | 🌐 Rust | 📅 2026-04-22 - A general-purpose Discord bot for Cosmos SDK blockchains.
...
* [cosmos-operator](https://github.com/strangelove-ventures/cosmos-operator) ⭐ 102 | 🐛 53 | 🌐 Go | 📅 2026-04-11 - Cosmos Operator is a kubernetes operator for managing cosmos nodes.
* [Cosmos Cache](https://github.com/Reecepbcups/cosmos-endpoint-cache) ⭐ 25 | 🐛 10 | 🌐 Python | 📅 2023-11-22 - Optimize Cosmos queries by caching responses for predefined sets of time (regex).
...
* [(Not So) Smart Cosmos, examples of common Cosmos app vulnerabilities](https://github.com/crytic/building-secure-contracts/tree/master/not-so-smart-contracts/cosmos) ⭐ 2,477 | 🐛 58 | 🌐 Solidity | 📅 2026-04-13
