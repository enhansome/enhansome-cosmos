...
* [Cosmos SDK](https://github.com/cosmos/cosmos-sdk/) ⭐ 7,049 | 🐛 232 | 🌐 Go | 📅 2026-08-24
...
* [Cosmos SDK](https://github.com/cosmos/cosmos-sdk/) ⭐ 7,049 | 🐛 232 | 🌐 Go | 📅 2026-08-24 - A Framework for Building High Value Public Blockchains in Go.
...
* [Agoric SDK](https://github.com/Agoric/agoric-sdk) ⭐ 357 | 🐛 1,806 | 🌐 TypeScript | 📅 2026-08-24 - Agoric JavaScript Smart Contract Platform.

## IBC

* [Interchain Standards](https://github.com/cosmos/ibc/) ⭐ 1,016 | 🐛 58 | 🌐 Go | 📅 2026-08-24 - Interchain Standards (ICS) for the Cosmos network & interchain ecosystem.
...
* [quint](https://github.com/informalsystems/quint) ⭐ 1,633 | 🐛 245 | 🌐 TypeScript | 📅 2026-08-20 - Executable specification language with delightful tooling.
...
* [cosmosvisor](https://github.com/cosmos/cosmos-sdk/tree/main/cosmovisor#readme) ⭐ 7,049 | 🐛 232 | 🌐 Go | 📅 2026-08-24 - Automates Cosmos SDK application binary upgrades.
